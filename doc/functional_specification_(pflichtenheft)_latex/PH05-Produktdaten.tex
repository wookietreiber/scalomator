...
\begin{description}
  \item[/D010/]
    \textit{Automatendefinition:} Die Struktur eines endlichen Automaten, bestehend aus Zuständen und Übergangen, wird in einer XML-Datei gespeichert, die der folgenden Definition (Listing \ref{xsd}) genügt.
...
\end{lstlisting}
	...
	Im Nachfolgenden sind ein beispielhafter Automat (Abbildung \ref{example_automaton}) und diedie ihn beschreibende XML-Datei (Listing \ref{example_xml}) aufgeführt.
