...
\item[/F0100/]
	\textit{Übergang erstellen:} Zustandsübergange stellen 
\item[/F0110/]
...
\subsection{Berechnungsprogramm}

Das Berechnungsprogramm ist eine separate Komponente, die unabhängig von der grafischen Benutzeroberfläche operiert.
...
\item[/F1110/]
	\textit{Ausgabe der Akzeptanz des Automaten für das eingegebene Wort}
\end{description}
