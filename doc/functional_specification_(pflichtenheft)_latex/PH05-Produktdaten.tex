...
\begin{description}
  \item[/D010/]
    \textit{Automatendefinition:} Die Struktur eines endlichen Automaten, bestehend aus Zuständen und Übergangen, wird in einer XML-Datei gespeichert, die der folgenden Definition genügt.
...
\end{lstlisting}
	...
	Im Nachfolgenden sind ein beispielhafter Automat und die hierzu erzeugte XML-Datei aufgeführt.

\begin{center}
	\includegraphics[width=8cm]{images/NFA-1.eps}
\end{center}

\begin{lstlisting}[caption=Erzeugte XML-Datei]
<?xml version="1.0" encoding="utf-8"?>
