...
\item[/F0030/]
	\textit{Zustand umbenennen:} Der Name eines Zustandes muss änderbar sein.
\item[/F0040/]
...
Die Bibliothek ist eine separate Komponente, die unabhängig von der grafischen Benutzeroberfläche operiert.
Es bietet auch die Möglichkeit, über die Kommandozeile gestartet zu werden und dort das Ergebnis der Simulation anzuzeigen.
